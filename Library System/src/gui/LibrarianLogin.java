...
public class LibrarianLogin extends javax.swing.JFrame {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(NameEnterance, javax.swing.GroupLayout.DEFAULT_SIZE, 117, Short.MAX_VALUE)
                    .addComponent(PasswordEnterance))
    ...
    private void LoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_LoginActionPerformed
        ...
        if (Validations.Name_Validation(NameEnterance.getText()) == 1) {
            try {
                AddNewLibrarian x[] = ReadLibrarian();
                int count = ReadLibrarianCount();
                for (int i = 0; i < count; i++) {
                    if (x[i].getName().equals(NameEnterance.getText()) && x[i].getPassword().equals(PasswordEnterance.getText())) {
                        m = true;
